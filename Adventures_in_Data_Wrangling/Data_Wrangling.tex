...
\begin{frame}
    ...
    \begin{itemize}
        \item Intiially a PostgreSQL database + tools to automatically generate results files for Student Records. {\tiny (ca.\ 2001–2002)}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Data set from 2009–2018 (S1):
        \begin{itemize}
            \item 9743 students, 578 paper offerings, \num{29238} enrolments
            \item ≈\,60\% enrolled in computing majors, ≈\,16\% in computing minors
            \item using a modified version of INFORMS database
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}[t]
        \begin{column}{0.5\paperwidth}
            \centering
            \structurebf{This would be great}
            \medskip
        ...
        \begin{column}{0.5\paperwidth}
            \centering
            \structurebf{But we’re still working on it…}
            \medskip
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item e.g., 3 pages of instructions to generate a student email list vs.\ a quick and dirty VBA app that queries LDAP.
        \item How can we educate non-technical end users?\tinyskip
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Can we convince the powers that be to implement something more modern? {\tiny (e.g., REST API, service bus, …)}
    \end{itemize}
    \bigskip
