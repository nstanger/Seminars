...
\frame
{
	\frametitle{\parbox[t]{\textwidth}{\ldots then we moved to \LaTeX \\
...
\frame
{
	...
	\begin{itemize}
		...
		\item Two separate stylesheets \(\Rightarrow\) harder to
...
\frame
{
	...
	\note[item]{Lab 3 is a good example of a lab document, with
	graphics, etc.}
}
...
\frame
{
	...
	\begin{itemize}
		...
		\note{For example, handling of special characters. Our handling
...
\frame
{
	...
	\begin{itemize}
		...
		solution is to use the XML-commons resolver.}
