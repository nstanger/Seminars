...
\usepackage[margin=1in,pdftex]{geometry}	% change margins to 1in
...
\url{http://info-nts-12.otago.ac.nz/something/LaTeX/whatever}. You will
also find in this directory a copy of this document and its source.
...
the floating aspect: in the source file, the table immediately follows
the text of Section~\ref{sec:lists}, but the in the final output the
table has floated to the top of page~\pageref{tab:lists}, and the main
text has automatically flowed itself around the table. We have some
control over this floating behaviour (and occasionally \LaTeX\ does get
it wrong), but it's usually safest to leave \LaTeX\ alone in this area.
