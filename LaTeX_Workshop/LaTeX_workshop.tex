...
\usepackage[a4paper,left=2cm,right=3cm,vmargin=2cm]{geometry}
	...
	of clever PDF features, such as active hyperlinks, bookmarks, etc.
	(see \cite{WebCompanion} for more information). For example, this
	document uses the \textsf{hyperref} package, and as a result all the
	citations and cross-references are actually live links (try it and
	see). Because this package redefines many of \LaTeX's internal
	macros, you should always load it last.
